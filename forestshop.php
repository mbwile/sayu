...
$ombi = "INSERT INTO mbolea VALUES('','$users_id','$name','$quantity','$price','$now')";
mysqli_query($con, $ombi);
}

$ombi= "SELECT * FROM mbolea WHERE `users_id` = $users_id";
...
if(isset($_GET['isEditing']) && $_GET['isEditing']==1){
    $editId = $_GET['editId'];
    $isEditing = 1;
     $query = "SELECT * FROM mbolea WHERE `id` = $editId LIMIT 1";
 ...
 if(isset($_POST['update'])){
    ...
    $update_query = "UPDATE mbolea SET name='$name',quantity='$quantity',price='$price'WHERE id='$editId'";
